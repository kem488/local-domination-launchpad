...
-- Add data retention trigger for privacy compliance
...
AS $$
BEGIN
  -- Delete scans older than 90 days that aren't qualified leads
  DELETE FROM public.business_scans 
  WHERE created_at < NOW() - INTERVAL '90 days' 
  AND (lead_qualified = false OR lead_qualified IS NULL);
END;
$$;
