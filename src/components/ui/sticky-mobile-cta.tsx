...
export const StickyMobileCTA = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-gradient-card/95 backdrop-blur-lg border-t border-border/50 p-3 safe-area-inset-bottom shadow-strong">
      <div className="flex items-center gap-3">
        <div className="flex-1 min-w-0">
          <div className="text-sm font-bold text-foreground">Free Business Consultation</div>
          <div className="text-xs text-muted-foreground truncate">Expert analysis & growth strategy</div>
        </div>
        <ConsultationPopup>
          <Button
            size="sm"
            className="bg-brand-orange hover:bg-brand-orange/90 text-brand-orange-foreground touch-target px-6 font-bold whitespace-nowrap btn-hover-effect shadow-medium rounded-lg"
            onClick={handleClick}
          >
            Get Consultation
          </Button>
